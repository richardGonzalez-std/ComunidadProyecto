...
<head>
    ...
    <link rel="stylesheet" href="../../Recursos/css/gid_style1.css">
...
<body>
    ...
    <div class="form-container">
        <form method="POST">
                <header>
                    <img src="img/Logo Peru de Lacroix.png" alt="" class="lgo">
                    <p> REPÚBLICA BOLIVARIANA DE VENEZUELA <br>
                     MINISTERIO DEL PODER POULAR PARA LA EDUCACIÓN <br>
                     U.E.N. "PERÚ DE LACROIX"<br>
                     LIDICE- CARACAS <br>
                   TELÉFONO: 0212.8635278</p>
            </header>
            ...
            <div class="scholar_info">
                <p>C.I.N° <span style="color:red;">*</span>: <input type="text" class="scholar1" name="Cedula" required></p>
            ...
            <div class="personal-student-info">
                ...
                <span>Apellidos<span style="color:red;">*</span>: <input type="text" name="registroApellido" class="personal_1" required></span><span> Nombres<span style="color:red;">*</span>: <input type="text" name="registroNombre" class="personal_2" required></span>
                <p>Lugar y Fecha de Nacimiento<span style="color:red;">*</span>: <input type="text" name="lugar" class="personal_3" required> <input name="fecha" type="date" required></span><span> Edad<span style="color:red;">*</span>: <input type="text" name="edad">
            ...
            <?php
                ...
                if ($estudiante == "ok") {
                    ...
                    echo '<script>
                        ...
                        window.location="../../Plantilla2.php?pagina2=nomina";
                    </script>';
            ...
            ?>
            <div class="btn-container" style="right: 10rem;"><button type="submit">FINALIZAR INSCRIPCIÓN</button></div>
